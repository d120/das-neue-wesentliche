...
?>
	<div class="beitrag beitrag<?php echo $layoutcss; ?>" style="<?php echo $float; ?>" id="post-<?php the_ID(); ?>">
...
/**
 Der Post mit der Id 3141 erh�lt keine Schnellbewertung, da es sich um einen Nachruf handelt.           			
*/ 
		...
		?>
			...
			<div class="metarechts">
				Geschrieben am <?php the_time('j. F Y'); ?> von <?php GebeDenVollenAutorennamenAus(); ?>.<br/>

				<?php if ($CSSAttrib == ' kommentar') : ?>
				Dieser Kommentar gibt nicht zwingend die Meinung der Fachschaft wieder.<br/>
				<?php endif; ?>

				<?php if (function_exists('wp2bb')) wp2bb(); ?>


				<br/>Kategorie: <?php the_category(' &bull; '); ?> <br /><?php the_tags('Schlagwörter: ', ' &bull; ', ''); ?> <?php edit_post_link('&bull; bearbeiten', '', ''); ?>
			</div>
		</div>
